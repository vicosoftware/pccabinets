<div class="container nav-header-container">
    ...
    <div class="col-auto pl-lg-0">
        <a href="index.php" title="Pofo" class="logo">
            <img src="assets/img/logo-black.svg" data-rjs="assets/img/logo-black.svg" alt="Precious Custom Cabinets" class="logo-dark">
            <img src="assets/img/logo-white.svg" data-rjs="assets/img/logo-white.svg" alt="Precious Custom Cabinets" class="logo-light default">
        </a>
    </div>
    <!-- end logo -->
                    ...
                    <div class="menu-back-div dropdown-menu megamenu-content mega-menu collapse mega-menu-full">
                        <ul>
                            ...
                            <li class="mega-menu-column col-lg-3 d-none d-lg-block">
                                ...
                                <ul>
                                    <li>
                                        <a href="home-creative-studio.html" class="menu-banner-image"><img src="assets/img/menu-banner-01.png" alt="portfolio"/></a>
                                    </li>
                                    <li>
                                        <a href="home-creative-business.html" class="menu-banner-image"><img src="assets/img/menu-banner-02.png" alt="portfolio"/></a>
                                    </li>
                                </ul>
                                <!-- end sub menu item  -->
                            </li>
