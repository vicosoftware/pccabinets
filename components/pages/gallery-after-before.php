<?php 
$title_page_main = "Before & After";
$title_page_description = "Know more about out last jobs and our great quality";
...
<section id="lightbox" class="wrapper bg-light">
    <div class="container py-10">
        <div class="grid grid-view gy-10 light-gallery-wrapper">
            ...
            $imgPath = "assets/img/gallery/before-after/";
            $imgDescription = "Before & After";
