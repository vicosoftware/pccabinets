<?php 
  ...
  $seo_data = array(
    ...
    'title' => $component['company_name'].' | Welcome',
    'title_sm' => $component['company_name_sm'].' | Welcome',
    'image_1' => $component['company_url'].'/assets/img/social-media-share/welcome-precious-custom-cabinets.jpg',
    'image_2' => $component['company_url'].'/assets/img/social-media-share/welcome-precious-custom-cabinets.jpg',
    'image_3' => $component['company_url'].'/assets/img/social-media-share/welcome-precious-custom-cabinets.jpg',
    'type' => "article",
    'description' => "We bring solutions to make life easier",
    'keywords' => "Custom Cabinets, Solutions",
      ...
      <div class="container py-14 py-md-16">
        ...
        <div class="row mb-5">
          <div class="col-md-10 col-xl-8 col-xxl-7 mx-auto text-center">
            <img src="img/icons/list.svg" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
      ...
      <div class="container pt-16 pb-14 pb-md-0">
        <div class="row gx-lg-8 gx-xl-0 align-items-center">
          <div class="col-md-5 col-lg-4 offset-lg-1 d-none d-md-flex position-relative">
            ...
            <figure><img src="img/photos/co1.png" srcset="img/photos/co1@2x.png 2x" alt=""></figure>
          </div>
          <!--/column -->
      ...
      <div class="container py-14 py-md-16">
        <div class="row mb-3">
          <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
            <img src="img/icons/team.svg" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
          ...
          <div class="carousel owl-carousel gap-small" data-margin="0" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "3"}, "1400":{"items": "4"}}'>
            ...
            <div class="item">
              <div class="item-inner">
                <div class="card">
                  <div class="card-body">
                    <img class="rounded-circle w-15 mb-4" src="img/avatars/te5.jpg" srcset="img/avatars/te5@2x.jpg 2x" alt="" />
            ...
            <div class="item">
              <div class="item-inner">
                <div class="card">
                  <div class="card-body">
                    <img class="rounded-circle w-15 mb-4" src="img/avatars/te6.jpg" srcset="img/avatars/te6@2x.jpg 2x" alt="" />
        ...
        <div class="row">
          <div class="col-xl-10 mx-auto">
            <div class="row align-items-center counter-wrapper gy-6 text-center">
              <div class="col-md-3">
                <img src="img/icons/check.svg" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">7518</h3>
                <p>Completed Projects</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="img/icons/user.svg" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">3472</h3>
                <p>Satisfied Customers</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="img/icons/briefcase-2.svg" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">2184</h3>
                <p>Expert Employees</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="img/icons/award-2.svg" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
      ...
      <div class="container pt-19 pb-14 pt-md-20 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
            ...
            <figure class="rounded"><img src="img/photos/about4.jpg" srcset="img/photos/about4@2x.jpg 2x" alt=""></figure>
          </div>
          <!--/column -->
          <div class="col-lg-6">
